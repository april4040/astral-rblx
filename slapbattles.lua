if getgenv().Astral_AlreadyLoaded ~= nil then error("Astral was already found running or you have other scripts executed!") return else getgenv().Astral_AlreadyLoaded = 0 end
...
local Config = {
    WindowName = "Astral | " .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name or "Slap Battles",
...
infoSec:CreateButton("Devil of Astral: april#8795", function()
...
infoSec:CreateButton("Blood sucking helper: WhoIsE", function()
    setclipboard("WhoIsE")
    
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Script Notification",
        Text = "Copied WhoIsE's username to your clipboard.",
        Duration = 5
    })
end)

infoSec:CreateButton("free easter egg 1", function()
    setclipboard("boo")
    
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Astral Note",
        Text = "paste the easter egg anywhere!",
        Duration = 5
    })
end)

infoSec:CreateButton("free easter egg 2", function()
    setclipboard("lol")
    
    game:GetService("StarterGui"):SetCore("SendNotification", {
        Title = "Astral Note",
        Text = "copied easter egg 2, paste it anywhere!",
        Duration = 5
    })
end)
